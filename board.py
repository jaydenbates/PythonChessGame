...
class Board():
    def __init__(self):
        ...
        player2SetupPawn = [piece.Pawn(True, [1, 0]), piece.Pawn(True, [1, 1]), piece.Pawn(True, [1, 2]), piece.Pawn(True, [1, 3]), piece.Pawn(True, [1, 4]), piece.Pawn(True, [1, 5]), piece.Pawn(True, [1, 6]), piece.Pawn(True, [1, 7])]
        ...
        player1SetupPawn = [piece.Pawn(False, [6, 0]), piece.Pawn(False, [6, 1]), piece.Pawn(False, [6, 2]), piece.Pawn(False, [6, 3]), piece.Pawn(False, [6, 4]), piece.Pawn(False, [6, 5]), piece.Pawn(False, [6, 6]), piece.Pawn(False, [6, 7])]
        emptyPlace = [None, None, None, None, None, None, None, None]
        self.board = [player2Setup, player2SetupPawn, emptyPlace, emptyPlace, emptyPlace, emptyPlace, player1SetupPawn, player1Setup]
